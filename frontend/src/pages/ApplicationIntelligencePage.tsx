...
const ApplicationIntelligencePage: React.FC = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'profiling': return 'text-blue-600';
      case 'analyzing': return 'text-yellow-600';
      case 'generating_suggestions': return 'text-purple-600';
  ...
  const renderOverview = () => (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        <h3 className="text-gray-500 text-sm mb-2">Security Score</h3>
        <div className="flex items-center">
          <span className={`text-4xl font-bold ${
            (profile?.security_score || 0) >= 80 ? 'text-green-600' :
            (profile?.security_score || 0) >= 60 ? 'text-yellow-600' :
            (profile?.security_score || 0) >= 40 ? 'text-orange-600' : 'text-red-600'
          }`}>
      ...
      {/* Codebase Stats */}
      <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        <h3 className="text-gray-500 text-sm mb-2">Codebase Size</h3>
      ...
      {/* Suggestions Stats */}
      <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        <h3 className="text-gray-500 text-sm mb-2">Rule Suggestions</h3>
      ...
      {/* Last Profiled */}
      <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        <h3 className="text-gray-500 text-sm mb-2">Last Profiled</h3>
  ...
  const renderTechStack = () => (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        ...
        <div className="text-sm text-gray-500 mt-1">Total packages</div>
      </div>
    </div>
  );
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        ...
        <div className="space-y-3 max-h-96 overflow-y-auto">
          {profile?.sensitive_data_fields?.slice(0, 20).map((field, idx) => (
            <div key={idx} className="bg-gray-50 rounded-lg p-3 flex justify-between items-start">
              <div>
                <div className="font-mono text-sm text-gray-700">{field.field}</div>
    ...
    <div>
      ...
      <div className="space-y-4">
        {suggestions.map((suggestion) => (
          <div key={suggestion.id} className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:bg-gray-750 transition-colors">
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <h3 className="text-lg font-semibold text-gray-700">{suggestion.name}</h3>
              </div>
            ...
            <div className="bg-gray-50 rounded-lg p-3 mb-4">
              <h4 className="text-sm font-medium text-gray-600 mb-1">Why this rule?</h4>
              ...
              {suggestion.status === 'pending' && (
                <>
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-gray-200 hover:bg-gray-500 rounded-lg text-sm font-medium transition-colors"
                  >
                    Dismiss
                  </button>
                </>
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-gray-500 text-sm mt-1">{selectedSuggestion.description}</p>
              </div>
              <button
