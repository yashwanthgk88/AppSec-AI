    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1">Comprehensive security metrics and analytics</p>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="relative">
            ...
            <select
              ...
              className="pl-10 pr-4 py-2 border border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 bg-gray-800"
            >
      ...
      {threatIntel?.stats && (
        <div className="card p-6 bg-gradient-to-r from-red-900/20 via-orange-900/20 to-yellow-900/20 border-l-4 border-red-500">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Real-time threat data from CISA KEV, NVD, and Exploit-DB</p>
              </div>
            </div>
            <Link
              to="/threat-intel"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            <div className="bg-gray-800 rounded-lg p-4 border border-red-700 shadow-sm">
            ...
            <div className="bg-gray-800 rounded-lg p-4 border border-orange-700 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-gray-400">Critical CVEs</p>
            ...
            <div className="bg-gray-800 rounded-lg p-4 border border-purple-700 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
            ...
            <div className="bg-gray-800 rounded-lg p-4 border border-pink-700 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
            ...
            <div className="bg-gray-800 rounded-lg p-4 border border-indigo-700 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
            ...
            <div className="bg-gray-800 rounded-lg p-4 border border-blue-700 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
          ...
          {threatIntel.correlations && threatIntel.correlations.length > 0 && (
            <div className="mt-4 p-4 bg-red-900/30 border-2 border-red-300 rounded-lg animate-pulse">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
      ...
      <div className="card p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-xl font-semibold text-white">Vulnerability Trend</h2>
            <p className="text-sm text-gray-400 mt-1">Track vulnerability discovery over time</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card p-6">
          <h2 className="text-xl font-semibold text-white mb-6">Severity Distribution</h2>
      ...
      <div className="card p-6">
        <h2 className="text-xl font-semibold text-white mb-6">Top Vulnerability Categories</h2>
        <ResponsiveContainer width="100%" height={350}>
      ...
      <div className="card p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-semibold text-white">Vulnerabilities by Project</h2>
                ...
                <tr key={project.project_id} className="hover:bg-gray-700">
                  <td className="px-4 py-4">
                    <Link
                      ...
                      className="font-medium text-white hover:text-primary-600"
                    >
                      {project.project_name}
                    </Link>
                  </td>
                  <td className="px-4 py-4 text-center">
                    <span className="text-lg font-bold text-white">{project.total}</span>
                  </td>
                  <td className="px-4 py-4 text-center">
                  ...
                  <td className="px-4 py-4">
                    <div className="flex space-x-1">
                      {project.critical > 0 && (
                        <div
                          className="h-6 bg-red-900/30 rounded"
                      ...
                      {project.high > 0 && (
                        <div
                          className="h-6 bg-orange-900/30 rounded"
                      ...
                      {project.medium > 0 && (
                        <div
                          className="h-6 bg-yellow-900/30 rounded"
                      ...
                      {project.low > 0 && (
                        <div
                          className="h-6 bg-blue-900/30 rounded"
          ...
          <div className="flex items-center justify-between mt-6 pt-4 border-t border-gray-700">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="px-3 py-2 border border-gray-600 rounded-lg text-sm font-medium text-gray-300 hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-1"
              >
      ...
      <div className="card p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-xl font-semibold text-white">Scan Activity</h2>
            <p className="text-sm text-gray-400 mt-1">Number of security scans over time</p>
          </div>
        </div>
      ...
      <div className="card p-6">
        <h2 className="text-xl font-semibold text-white mb-6">Top 5 Vulnerability Types</h2>
        <div className="space-y-4">
          {top_types.map((item: any, index: number) => (
            <div key={index} className="flex items-center">
              <div className="w-8 h-8 rounded-full bg-primary-900/30 text-primary-400 flex items-center justify-center font-bold text-sm mr-4">
                {index + 1}
              </div>
              <div className="flex-1">
                ...
                <div className="w-full bg-gray-600 rounded-full h-2">
                  <div
                    className="bg-gradient-to-r from-primary-900/30 to-primary-600 h-2 rounded-full transition-all duration-300"
...
function MetricCard({ title, value, icon, color, subtitle }: any) {
  const colorClasses = {
    ...
    yellow: 'bg-yellow-900/30 text-yellow-600',
