...
import { Shield, LayoutDashboard, FolderKanban, MessageSquare, Settings, LogOut, Menu, X, FileCode, BarChart3, Activity, Zap, Brain, GitBranch, FileText } from 'lucide-react'
...
export default function Layout({ children, onLogout }: LayoutProps) {
  ...
  const navigation = [
    ...
    { name: 'Threat Intel', href: '/threat-intel', icon: Zap },
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-16 px-6 border-b border-gray-700">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-lg font-bold text-white">SecureDev AI</span>
            </div>
            <button
              onClick={() => setSidebarOpen(false)}
          ...
          <div className="p-4 border-t border-gray-700">
            <div className="flex items-center space-x-3 mb-3">
              <div className="w-10 h-10 bg-primary-900/50 rounded-full flex items-center justify-center">
                <span className="text-primary-400 font-semibold">A</span>
              </div>
            ...
            <button
              onClick={onLogout}
              className="flex items-center space-x-2 w-full px-3 py-2 text-sm text-red-400 hover:bg-red-900/30 rounded-lg transition"
            >
        ...
        <div className="sticky top-0 z-30 bg-gray-800 border-b border-gray-700">
          <div className="flex items-center justify-between h-16 px-6">
            ...
            <div className="flex items-center space-x-4 ml-auto">
              <div className="hidden md:flex items-center space-x-2 px-3 py-1.5 bg-green-900/30 text-green-400 text-sm rounded-lg">
