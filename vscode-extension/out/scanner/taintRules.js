...
exports.TAINT_PROPAGATORS = exports.TAINT_SINKS = exports.TAINT_SOURCES = void 0;
exports.getSourcesByCategory = getSourcesByCategory;
exports.getSinksByCategory = getSinksByCategory;
exports.getSinksByVulnerabilityType = getSinksByVulnerabilityType;
exports.getSanitizers = getSanitizers;
exports.getSourcesForLanguage = getSourcesForLanguage;
exports.getSinksForLanguage = getSinksForLanguage;
// ============================================================================
...
function getSourcesByCategory(category) {
    return exports.TAINT_SOURCES.filter(s => s.category === category);
}
function getSinksByCategory(category) {
    return exports.TAINT_SINKS.filter(s => s.category === category);
}
function getSinksByVulnerabilityType(vulnType) {
    return exports.TAINT_SINKS.filter(s => s.vulnerabilityType === vulnType);
}
function getSanitizers() {
    return exports.TAINT_PROPAGATORS.filter(p => p.propagationType === 'sanitizer');
}
function getSourcesForLanguage(language) {
    ...
    return exports.TAINT_SOURCES.filter(s => prefixes.some(p => s.id.startsWith(p)));
}
function getSinksForLanguage(language) {
    const languagePatterns = {
    ...
    const prefixes = languagePatterns[language] || ['generic-'];
    return exports.TAINT_SINKS.filter(s => prefixes.some(p => s.id.startsWith(p)));
}
//# sourceMappingURL=taintRules.js.map