...
exports.RulePerformancePanel = void 0;
const vscode = __importStar(require("vscode"));
class RulePerformancePanel {
    ...
    static show(apiClient) {
        ...
        if (RulePerformancePanel.currentPanel) {
            ...
            const panel = vscode.window.createWebviewPanel('rulePerformance', 'Rule Performance Dashboard', column, {
                enableScripts: true,
    ...
    async viewRuleDetails(ruleId) {
        try {
            ...
            const panel = vscode.window.createWebviewPanel('ruleDetails', `Rule: ${rule.name}`, vscode.ViewColumn.Beside, { enableScripts: true });
...
exports.RulePerformancePanel = RulePerformancePanel;
//# sourceMappingURL=RulePerformancePanel.js.map